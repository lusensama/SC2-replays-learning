...
from keras.layers import Dense, Dropout, Flatten, Reshape, Concatenate, Input
...
def build_model_keras(infosize, msize, ssize):
    ...
    value = Dense(1, activation=None)(hidden1)
...
training_generator = Mygenerator(batch_size, PATH_REPLAY)
